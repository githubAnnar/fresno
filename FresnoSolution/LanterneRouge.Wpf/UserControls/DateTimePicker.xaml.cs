...
namespace LanterneRouge.Wpf.UserControls
{
    /// <summary>
    ...
    public partial class DateTimePicker : UserControl
    {
        ...
        public static readonly DependencyProperty SelectedDateProperty = DependencyProperty.Register("SelectedDate", typeof(DateTime), typeof(DateTimePicker), new FrameworkPropertyMetadata(DateTime.Now, new PropertyChangedCallback(OnSelectedDateChanged), new CoerceValueCallback(CoerceDate)));
        ...
        DateTime? ParseDateText(bool flexible)
        {
            ...
            if (!DateTime.TryParseExact(DateDisplay.Text, InputDateFormat(), null, DateTimeStyles.AllowWhiteSpaces, out DateTime selectedDate))
            {
